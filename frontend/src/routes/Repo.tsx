...
const exampleRust = `use core::marker::PhantomData;
      ...
      <AppShellMain style={{ height: '100vh' }}>
        <Allotment defaultSizes={[0.9, 2, 2]}>
          <Allotment.Pane>
            ...
            >
              <TreeItem nodeId="1" label="examples">
                <TreeItem
                  nodeId="2"
                  label="square_root.rs"
                  icon={<IconBrandRust color="#6d8086" />}
                />
              </TreeItem>
              ...
              <TreeItem
                nodeId="5"
                label="Cargo.toml"
                icon={<IconToml color="#6d8086" />}
              />
              <TreeItem
                nodeId="6"
                label="Cargo.lock"
                icon={<IconAlignLeft color="#6d8086" />}
              />
            </TreeView>
          </Allotment.Pane>
          <Allotment.Pane>
